...
class OffensiveReflexAgent(ReflexCaptureAgent):
  ...
  def getWeights(self, gameState, action):
    return {'successorScore': 100, 'distanceToFood': -1, 'numInvaders': -1000, 'invaderDistance': -10,'numDefenders': -1000, 'defenderDistance': -10, 'numCloseDefenders': -1000, 'closeDefenderDistance': -10}
